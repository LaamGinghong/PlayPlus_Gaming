		...
		<div id="player_summary">
			<ul class="container">
				<li v-for="values in player">
					<ul class="row">
						<li class="col-md-6 player_details_image"><img v-bind:src="values.p_image_large" width="500px" height="500px" /></li>
						<li class="col-md-6 player_details_summary_details">
							<ul>
								<li class="player_details_userid">{{values.p_userid}}</li>
								<li class="player_details_name">{{values.p_name}}</li>
								<ul>
									<li class="player_details_kda col-md-4">{{values.p_kda}}</li>
									<li class="player_details_CS col-md-4">{{values.p_CS}}</li>
									<li class="player_details_teamfight col-md-4">{{values.p_teamfight}}%</li>
								</ul>
								<ul>
									<li class="col-md-4 player_kda_avg"><span class="content_box">场均KDA</span></li>
									<li class="col-md-4 player_cs_avg"><span class="content_box">场均补刀</span></li>
									<li class="col-md-4 player_teamfight_avg"><span class="content_box">场均参团率</span></li>
								</ul>
							</ul>
						</li>
					</ul>
			...
			<ul class="container player_details_summary_details2">
				<li v-for="values in player" class="col-md-2 col-md-offset-2">
					<ul class="row">
